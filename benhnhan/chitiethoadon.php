...
<!-- Messenger Plugin chat Code -->
    ...
    <!-- header-end -->
     <div class="our_department_area">
        <div class="container">
        <a href="benhan.php" class="non-style-link"><button  class="btn-success btn button-icon btn-delete"  style="padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Quay lại</font></button></a> <br> <hr>
            <div class="row">
                <div class="col-xl-12">
...
<!-- link that opens popup -->
    ...
    <script src="benhnhan/js/main.js"></script>
    <script>
