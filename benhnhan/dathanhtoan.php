...
<body>
            ...
            <?php
                ...
                <?php
                    ...
                    $sqlmain= "select lichkham.id,chuyenkhoa.tenck,lichkham.trangthaithanhtoan, bacsi.tenbs,benhnhan.tenbn,lichtrinh.ngaykham,lichkham.lichngaykham,lichkham.giokham,lichkham.trangthai from lichtrinh inner join lichkham on lichtrinh.id=lichkham.idlt inner join benhnhan on benhnhan.id=lichkham.idbn inner join bacsi on lichtrinh.idbs=bacsi.id inner join chuyenkhoa on lichtrinh.idck= chuyenkhoa.id where lichkham.trangthaithanhtoan='Đã thanh toán' AND lichtrinh.ngaykham>='$today'AND lichkham.idbn=$idbn order by lichtrinh.ngaykham asc";
...
<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="edit-appointment.php?id='.$idbn.'&idlk='.$appoid.'"><i class="fa fa-pencil m-r-5"></i> Đổi lịch khám</a>
												 </div>
                                            </div>
                                        </td>
                                    </tr>
    ...
    if($_GET){
        ...
        if($action=='Xemchitiet'){
            $sqlmain2= "select lichkham.id,chuyenkhoa.tenck,lichkham.trangthaithanhtoan, bacsi.tenbs,benhnhan.tenbn,lichtrinh.ngaykham,lichkham.lichngaykham,lichkham.giokham,lichkham.trangthai from lichtrinh inner join lichkham on lichtrinh.id=lichkham.idlt inner join benhnhan on benhnhan.id=lichkham.idbn inner join bacsi on lichtrinh.idbs=bacsi.id inner join chuyenkhoa on lichtrinh.idck= chuyenkhoa.id where lichkham.trangthaithanhtoan='Đã thanh toán' and lichkham.id='$idlkham' AND lichkham.idbn='$id'limit 1";
            ...
            <div id="popup1" class="overlay" style="z-index:111">
                    ...
                    <center>
                        <h2></h2>
                        <a class="close" href="./dathanhtoan.php">&times;</a>
                        <div class="content">  
                        </div>
