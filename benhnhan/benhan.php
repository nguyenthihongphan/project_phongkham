 ...
 <div class="page-wrapper">
         ...
         <div class="row">
               ...
               // $sqlmain="select * from lichkham";
                ...
                $sqlmain= "select *, benhan.id from benhan inner join benhnhan on benhan.idbn=benhnhan.id inner join bacsi on benhan.idbs=bacsi.id where benhan.idbn='$idbn' order by benhan.id asc ";
