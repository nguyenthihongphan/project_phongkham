                ...
                <div class="row filter-row">
                    <div class="col-sm-3 col-md-8">
                        ...
                        <form method="post" >
                            ...
                            <input  style="width:700px" type="text" class="form-control floating"  name="timkiem" placeholder="Nhập thông tin tìm kiếm" value ="<?php if(isset($_POST["timkiem"])){echo $_POST ["timkiem"];} ?>"/ >
                        </div>
                    </div>
