...
<!-- Messenger Plugin chat Code -->
    ...
    <!-- header-end -->
      <!-- bradcam_area_start  -->
    <div class="bradcam_area breadcam_bg_5 bradcam_overlay">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                    <div align="center" class="bradcam_text">
                        <h3>Thông tin liên hệ</h3>
                        <hr width="500px">
                        <p>Nếu quý bệnh nhân và khách hàng có bất kỳ thắc mắc liên quan đến các dịch vụ chăm sóc sức khỏe, xin vui lòng liên hệ với chúng tôi qua hotline: Hotline: <b style="color:#FC3">0374 389 835</b> Tư vấn: <b style="color:#FC3">0325 930 787</b> hoặc gửi thông tin cho chúng tôi theo mẫu bên dưới:</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="contact-section">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-5">
                     <h2 class="contact-title">Gửi tin nhắn trực tiếp</h2>
                    <p>Vui lòng chia sẻ thông tin về nhu cầu của bạn tại đây để đội ngũ chuyên gia của phòng khám hỗ trợ bạn một cách nhanh chóng và hiệu quả nhất.</p>
                    ...
                    <h2 class="contact-title">Phòng khám đa khoa ĐP</h2>
                        <div class="media contact-info">
                            <span class="contact-info__icon"><i class="ti-home"></i></span>
                            <div class="media-body">
                                <h3> 12 Nguyễn Văn Bảo Phường 4 Gò Vấp TP.HCM.</h3>
                        ...
                        <div class="media contact-info">
                            ...
                            <div class="media-body">
                                <h3>Hotline: 0374389835</h3>
                                <p>Đặt lịch online: 7:00 - 16:00</p>
