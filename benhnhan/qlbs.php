				...
				echo' <div class="col-md-4 col-sm-4  col-lg-3" >
				 <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar"  href="doctor.php?id='.$id.'"><img height="200px" width ="200px" alt="" src="../Admin/assets/img/'.$anh.'"></a>
                            </div>
                            
                            <h4 class="doctor-name text-ellipsis"><a href="doctor.php?id='.$id.'">'.$tenbs.'</a></h4>
							<h5 class="doc-prof">'.$tenck.'</h5>
