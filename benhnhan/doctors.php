...
<head>
    ...
    <title>Phòng khám gia đình DP</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-12">
                             ...
                             <?php echo $p->doctors("select bacsi.id,bacsi.anh,bacsi.tenbs, bacsi.email, chuyenkhoa.tenck from bacsi, chuyenkhoa where bacsi.idck = chuyenkhoa.id");?>
                    </div>
