...
<div class="header">
    ...
    if($_GET){
        ...
        $sqlmain="select tennv from nhanvien where id=$id ";
            ...
            <div id="popup1" class="overlay" style="z-index:111">
                <div class="popup">
						...
						<h4>Xác nhận xóa nhân viên : '.$name.'</h4>
                        </div>
                        </div>
						...
						<div class="m-t-20"> <a href="employees.php" class="btn btn-white" data-dismiss="modal">Đóng</a>
                        <a href="delete-employee.php?idnv='.$id.'" class="non-style-link"><button type="submit" class="btn btn-danger">Xóa</button></a>
						</div>
					</div>
				</div>
			</div>
