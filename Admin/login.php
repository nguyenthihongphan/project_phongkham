...
$p= new login();
$ten=$p->luachon("SELECT bacsi.iduser from bacsi inner join taikhoan on bacsi.iduser = taikhoan.id");
?>
<!doctype html>
<html>
<head>
        ...
        <div class="header">
            <div class="">
             ...
             <div class="nav float-right">
                   ...
                   <a href="login.php" class="text-white" > <span style="margin-right: 35px; margin-top:20px ">Bạn chưa đăng nhập</span></a>
			...
			<div class="account-center">
				<div class="account-box">
                    <form action="" method="POST" class="form-signin">
                        ...
                        <div class="form-group">
                            <p > <a href="../user.php">Quay lại</a></p>
                            </div>
                        <div class="form-group">
                        <?php
                          switch($_POST['nut'])
                              ...
                              case 'Đăng nhập':
                              {
                                  ...
                                  if($user!=''&&$pass!='')
                                  {
                                      ...
                                      { if ($_SESSION['phanquyen'] == '1') {  
										...
										echo '<b style="color:red;font-size:16px;font-family:calibri ;">Bạn không phải quản lý phòng khám </b>';
										}
									  }
                                        else
                                        {
                                        echo '<b style="color:red;font-size:16px;font-family:calibri ;">Đăng nhập sai username hoặc password! </b>';
                                            }
                                      }
                                 else
                                    {
