...
$appointmentrow =$mysqli->query("select  lichtrinh.ngaykham from  lichkham inner join lichtrinh on lichkham.idlt=lichtrinh.id where lichtrinh.ngaykham>='$today';");
    ...
    <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            <span class="dash-widget-bg4"><i class="fa-solid fa-clipboard-user"></i></span>
                            <div class="dash-widget-info text-right">
                                <h3> <?php    echo $employeerow->num_rows  ?></h3>
                                <span class="widget-title4">Nhân viên<i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
				<div class="row">
						...
						<div class="card">
							<div class="card-body">
								<div class="chart-title">
									...
									<span class="float-right"><i class="fa fa-caret-up" aria-hidden="true"></i> 15% cao hơn so với tháng trước</span>
								</div>	
					...
					<div class="col-12 col-md-6 col-lg-6 col-xl-6">
						<div class="card">
							<div class="card-body">
								<div class="chart-title">
									<h4>Bệnh nhân trong giai đoạn khám</h4>
									<div class="float-right">
										<ul class="chat-user-total">
											<li><i class="fa fa-circle current-users" aria-hidden="true"></i>Người mới</li>
											<li><i class="fa fa-circle old-users" aria-hidden="true"></i>Người cũ</li>
										</ul>
									</div>
								</div>	
					...
					<div class="col-12 col-md-6 col-lg-8 col-xl-8">
						<div class="card">
							<div class="card-header">
								<h4 class="card-title d-inline-block">Lịch hẹn khám sắp tới</h4> <a href="appointments.php" class="btn btn-primary float-right">Xem tất cả</a>
							</div>
							<div class="card-body p-0">
								<div class="table-responsive">
									<table class="table mb-0">
										...
										<?php
										echo $q->lichkham("select benhnhan.id,benhnhan.tenbn,lichtrinh.ngaykham, lichkham.giokham,benhnhan.sdt, bacsi.id, bacsi.tenbs from benhnhan inner join lichkham on benhnhan.id=lichkham.idbn  inner join bacsi on lichkham.idbs = bacsi.id inner join lichtrinh on lichkham.idlt=lichtrinh.id where lichtrinh.ngaykham >='$today' ");
										?>
									</table>
								</div>
							</div>
                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4">
                        <div class="card member-panel">
                                    ...
                                    <li>
                                        <div class="contact-cont">
                                            ...
                                            <div class="contact-info">
                                                <span class="contact-name text-ellipsis"><?php echo $tenbs ;?></span>
                                                <span class="contact-date"><?php echo $sdt ;?></span> <br>
                                               <span> Nguyễn Anh Duy</span><br>
                                                <span class="contact-date">037898312</span>
                                            </div>
                            ...
                            <div class="card-footer text-center bg-white">
                                <a href="doctors.php" class="text-muted">Xem tất cả</a>
                            </div>
                        </div>
                    </div>
				</div>
