...
<div class="col-sm-6">
	...
	{	
		...
		if($tenbn!='' && $tenck!='')
		{		
				if($p->themxoasua("INSERT INTO lichkham(idck,idbn,idbs,giokham,lichngaykham,phidichvu,trangthai,idlt) VALUES ('$tenck' ,'$tenbn', '$tenbs', '$giokham', '$today','$phidichvu','$trangthai','$idlt')")==1)
				{	
					echo '<script >alert("Thêm thành công!"); window.location="appointments.php";</script>';					
					}
				else
				{
