...
<head>
    ...
    <title>Trang thông tin bác sĩ</title>
...
<div class="header">
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="page-wrapper">
          ...
          <?php
		  	$p->loadchitietbs("select bacsi.tenbs, bacsi.chucvu,bacsi.diachi, bacsi.id, bacsi.idck,bacsi.linhvuc,bacsi.anh, bacsi.gioitinh, bacsi.ngaysinh, bacsi.email, bacsi.sdt, bacsi.sdt, chuyenkhoa.tenck from bacsi inner join chuyenkhoa on bacsi.idck = chuyenkhoa.id where bacsi.id ='$id' order by id desc");
		
		    $sqlmain= "select id,soluong,ngaykham, TIME(gioketthuc) AS gioketthuc, TIME(giobatdau) AS  giobatdau from lichtrinh where lichtrinh.idbs='$id' and lichtrinh.ngaykham>='$today' order by lichtrinh.ngaykham asc ";
                            ...
                            <?php
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                   ...
                                   $idlt=$row["id"];								   
									...
									<td>
                                     <a href="?action=Xem&idlt='.$row["id"].' &id='.$id.'" class="non-style-link"><button  class="btn-primary btn button-icon btn-view"  style="padding-top: 12px;padding-bottom: 12px;margin-top: 10px;"><font class="tn-in-text">Xem chi tiết</font></button></a>
                                        </td>                                        
                                    </tr>';                                    
                                }
                            }                                 
    ...
    if($_GET){
       ...
       if($action=='Xem'){
            ...
            <div id="popup1" class="overlay" style="z-index:111">
                    ...
                    <center>
                        <h2></h2>
                        <a class="close" href="profile.php?id='.$id.'">&times;</a>
                        <div class="content">  
                        </div>
