	...
	public function patients($sql)
		{
			...
			if($i>0)
				...
				echo'  <tbody>
									...
									<td>'.$dem.'</td>
										...
										<a><img width="20" height="20"  src="assets/img/user.jpg" class="rounded-circle m-r-5" alt="">'.$tenbn.'</a>
										</td>
                                       <td href="#">0'.$id.'</td>
									   <td href="#" width="15%">'.$ngaysinh.'</td>
									    <td  href="#">'.$gioitinh.'</td>
										<td href="#">'.$diachi.'</td>
										<td href="#">0'.$sdt.'</td>
										<td href="#">'.$email.'</td>
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="?action=delete&idbn='.$id.'"><i class="fa fa-trash-o m-r-5"></i> Xóa</a>
												</div>
											</div>
										</td>
									</tr>
			...
			{
				echo' Không có tên bệnh nhân nào vừa tìm kiếm!';
