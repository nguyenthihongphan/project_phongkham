...
<div class="header">
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-3">
                        <h4 class="page-title">Bệnh nhân(<?php echo $patientsrow->num_rows?>)</h4>
                    </div>
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-patient.php" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Thêm bệnh nhân</a>
                    </div>
                </div>
    ...
    if($_GET){
        ...
        $sqlmain="select tenbn from benhnhan where id=$id ";
            ...
            <div id="popup1" class="overlay" style="z-index:111">
                <div class="popup">
                        ...
                        <a href="delete-patient.php?idbn='.$id.'" class="non-style-link"><button type="submit" class="btn btn-danger">Xóa</button></a>
						</div>
					</div>
				</div>
			</div>
