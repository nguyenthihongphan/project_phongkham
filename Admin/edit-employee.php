                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                       <label>Họ và tên<span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" id="ten" name="tennv" value="<?php echo $p->luachon("select tennv from nhanvien where id ='$layid' limit 1 ");?>"/>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="username" name="usename"  value="<?php  echo $q->luachon("select username from nhanvien where id='$layid' limit 1");?>" >
                               ...
                               <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" id="password" name="pass"  value="<?php  echo $q->luachon("select password from nhanvien where id='$layid' limit 1");?>" >
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Địa chỉ</label>
                                        <input type="text" class="form-control" id="diachi" name="diachi"  value="<?php  echo $p->luachon("select diachi from nhanvien where id='$layid' limit 1");?>">
                             ...
                             <div class="form-group">
                                ...
                                <input class="form-control" type="text" id="phanquyen" name="phanquyen" readonly value="<?php  echo $p->luachon("select phanquyen from nhanvien where id='$layid' limit 1");?>"/>
                            </div>
                            </div>
                             <div class="col-sm-6">
                             <div class="form-group">
                                <label>Chức vụ</label>
                                <input class="form-control" type="text" id="chucvu" name="chucvu" readonly	 value="<?php  echo $p->luachon("select chucvu from nhanvien where id='$layid' limit 1");?>"/>
                            </div>
                            </div>
                            
                            <div class="m-t-20 text-center">
                               
                                <input type="submit"  class="btn btn-primary submit-btn" data-dismiss="modal" id="save" name="capnhat" value="Cập nhật nhân viên"/>
                            </div>
    <?php
