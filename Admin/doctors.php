...
<div class="header">
        ...
        <div class="page-wrapper">
            <div class="content">
				...
				<div class="row doctor-grid">
                        ...
                        <?php $p->doctors("select bacsi.tenbs,bacsi.email,bacsi.anh,bacsi.id, chuyenkhoa.tenck from bacsi join chuyenkhoa on bacsi.idck=chuyenkhoa.id  order by bacsi.id asc");
    ...
    if($_GET){
        ...
        $sqlmain="select bacsi.tenbs,bacsi.email,bacsi.anh,bacsi.id, chuyenkhoa.tenck from bacsi join chuyenkhoa on bacsi.idck=chuyenkhoa.id where bacsi.id=$id ";
            ...
            <div id="popup1" class="overlay" style="z-index:111">
                <div class="popup">
						...
						<h4>Xác nhận xóa bác sĩ : '.$name.'</h4>
                        </div>
                        </div>
                        ...
                        <a href="delete-doctor.php?idbs='.$id.'" class="non-style-link"><button type="submit" class="btn btn-danger">Xóa</button></a>
						</div>
					</div>
				</div>
			</div>
