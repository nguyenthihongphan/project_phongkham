				 ...
				 <div class="col-md-12">
				  <div class="blog grid-blog">
                            ...
                            <div class=" col-md-3 blog-image">
                                <a href="blog-details.php?id='.$id.'"><img class="img-fluid" src="../Admin/assets/img/'.$anh.'" alt=""></a>
                            </div>
                        ...
                        <div class="blog-view">
                            <article class="blog blog-single-post">
                                ...
                                <div class="blog-info clearfix">
                                    ...
                                    <div class="post-right"><a href="#."><i class="fa fa-comment-o"></i>1 bình luận</a></div>
                                </div>
                                <div class="blog-image">
                                    <a href="#."><img alt="" class="img-fluid" src="../Admin/assets/img/'.$anh.'"></a>
                                </div>
                                <div class="blog-content">
                                    <p>'.$noidung.'</p>
                                    </div>
