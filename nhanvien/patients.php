    ...
    <div class="sidebar" id="sidebar">
     ...
     <div class="page-wrapper">
            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h4 class="page-title">Bệnh nhân</h4>
                    </div>
                    <div class="col-sm-12 text-right ">
			<a href="add-patient.php" id="create_new" class="btn btn-flat btn-primary"><span class="fa fa-plus"></span>  Thêm bệnh nhân</a>
                    </div>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-6 ">
                        ...
                        <form method="post">
                            <label class="focus-label" >Bệnh nhân</label>
                            <input type="text" class="form-control floating" style="width:500px"  name="timkiem" placeholder="Nhập thông tin tìm kiếm" value ="<?php if(isset($_POST["timkiem"])){echo $_POST ["timkiem"];} ?>" >
                        </div>
</div>
                    <div class="col-md-6">                       
                         <button  class="btn btn-success " name="">Tìm kiếm</button> 
                         </form>                                           
                         </div> 
</div>
                </div>              
		...
		if($layid>0)
		{
			$p->patients("select * from benhnhan where  id='$layid' order by id asc");
		}
		else
		{
			$p->patients('select * from benhnhan where 1 and tenbn like "%'.$timkiem.'%"  order by id asc');
		}
			...
			<div class="modal-dialog modal-dialog-centered">
				<div class="modal-content">
					<div class="modal-body text-center">						
						<h3>Xác nhận xóa bệnh nhân '.$tenbn.'</h3>
                        
						<div class="m-t-20"> <a href="patients.php" class="btn btn-white" data-dismiss="modal">Đóng</a>
                        <a href="delete-patient.php?id='.$id.'" class="btn btn-danger">Xóa</a>
						</div>
					</div>
				</div>
			</div>
