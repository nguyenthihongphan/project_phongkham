                ...
                <?php
                  if(ISSET($_POST['filter'])){
                    if(isset($_POST['bacsi']) && empty($_POST['ngaykham_search'])){
                        $bacsi=$_POST['bacsi'];
                        $sqlmain= "select lichkham.id, bacsi.tenbs,benhnhan.tenbn,lichtrinh.ngaykham,lichkham.lichngaykham,lichkham.giokham,lichkham.trangthai from lichtrinh inner join lichkham on lichtrinh.id=lichkham.idlt inner join benhnhan on benhnhan.id=lichkham.idbn inner join bacsi on lichtrinh.idbs=bacsi.id where lichkham.lichngaykham<='$today' and lichkham.trangthai ='Chưa khám' and lichkham.trangthaithanhtoan ='Đã thanh toán' AND lichtrinh.idbs='$bacsi' order by lichkham.lichngaykham asc";
                    }
                    else{  
...
<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="edit-appointment.php?id='.$appoid.'"><i class="fa fa-pencil m-r-5"></i> Sửa</a>
												 </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        $sqlmain="select benhnhan.tenbn from lichkham inner join benhnhan on lichkham.idbn=benhnhan.id where lichkham.id=$id ";
            ...
            <div id="popup1" class="overlay" style="z-index:111">
                <div class="popup">
                        ...
                        <a class="close" href="cho_kham.php">&times;</a>
                        <div class="content">
						...
						<div class="m-t-20"> <a href="cho_kham.php" class="btn btn-white" data-dismiss="modal">Đóng</a>
