	...
	{	
		...
		{						
			...
			if($p->uploadfile($name,$tmp_name,"../Admin/assets/img")==1)
			{
				  ...
				  if($p->themxoasua("INSERT INTO tintuc(tentintuc,tieude,id_danhmuc,noidung,anh,nguoidang,ngaydang,tinhtrang) VALUES ('$tentintuc','$tieude','$danhmuc','$noidung', '$name', '$nguoidang', '$ngaydang',0)")==1)
			  			{
