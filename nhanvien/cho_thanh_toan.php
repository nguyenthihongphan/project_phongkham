            ...
            <div class="content">
                ...
                <div class="row">
                    <div class="col-sm-6 col-6">
                        <h4 class="page-title">Lịch hẹn chưa thanh toán</h4>
                    </div>
                ...
                <?php
                  if(ISSET($_POST['filter'])){
                    if(isset($_POST['bacsi']) && empty($_POST['ngaykham_search'])){
                        $bacsi=$_POST['bacsi'];
                        $sqlmain= "select lichkham.id,bacsi.tenbs,benhnhan.tenbn,lichtrinh.ngaykham,lichkham.lichngaykham,lichkham.giokham,lichkham.trangthai,lichkham.trangthaithanhtoan from lichtrinh inner join lichkham on lichtrinh.id=lichkham.idlt inner join benhnhan on benhnhan.id=lichkham.idbn inner join bacsi on lichtrinh.idbs=bacsi.id where lichkham.lichngaykham<='$today' and lichkham.trangthai ='Chưa khám' and lichkham.trangthaithanhtoan ='Chưa thanh toán' AND lichtrinh.idbs='$bacsi' order by lichkham.lichngaykham asc";
                    }
                    else{  
                        $ngaykham_search=$_POST['ngaykham_search'];   
                        $sqlmain= "select lichkham.id,bacsi.tenbs,benhnhan.tenbn,lichtrinh.ngaykham,lichkham.lichngaykham,lichkham.giokham,lichkham.trangthai , lichkham.trangthaithanhtoan from lichtrinh inner join lichkham on lichtrinh.id=lichkham.idlt inner join benhnhan on benhnhan.id=lichkham.idbn inner join bacsi on lichtrinh.idbs=bacsi.id where lichkham.lichngaykham ='$ngaykham_search'";
                  }
                }
                  else{
                    $sqlmain= "select lichkham.idbn,lichkham.id,bacsi.tenbs,benhnhan.tenbn,lichtrinh.ngaykham,lichkham.lichngaykham,lichkham.giokham,lichkham.trangthai,lichkham.trangthaithanhtoan from lichtrinh inner join lichkham on lichtrinh.id=lichkham.idlt inner join benhnhan on benhnhan.id=lichkham.idbn inner join bacsi on lichtrinh.idbs=bacsi.id where lichkham.lichngaykham<='$today' and lichkham.trangthai ='Chưa khám' and lichkham.trangthaithanhtoan ='Chưa thanh toán'  order by lichkham.lichngaykham asc";
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
									 <td>'.                                       
                                        ...
                                        <td class="text-left">
                                        <a style="color:#fff" href="./vnpay_php/index.php?thanhtoan=Xem&idbn='.$idbn.'&idlk='.$appoid.'"><button class="btn btn-success" > Thanh toán</a></button>
                                    </td>
<td class="text-right">
        ...
        $sqlmain="select *, benhnhan.tenbn from lichkham inner join benhnhan on lichkham.idbn=benhnhan.id where lichkham.id=$id ";
            ...
            <div id="popup1" class="overlay" style="z-index:111">
                <div class="popup">
                        ...
                        <a class="close" href="cho_thanh_toan.php">&times;</a>
                        <div class="content">
						...
						<div class="m-t-20"> <a href="cho_thanh_toan.php" class="btn btn-white" data-dismiss="modal">Đóng</a>
                        <a href="delete-appointmenttt.php?idlk='.$id.'" class="non-style-link"><button type="submit" class="btn btn-danger">Hủy lịch</button></a>
						</div>
					</div>
				</div>
			</div>
