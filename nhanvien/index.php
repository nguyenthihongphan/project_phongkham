                 ...
                 <div class="col-md-12">
                        ...
                        <tr >
                            ...
                            <td width="15%">
                                ...
                                $appointmentrow = $mysqli->query("select  * from  lichkham inner join lichtrinh on lichkham.idlt=lichtrinh.id where lichtrinh.ngaykham>='$today' AND lichkham.trangthai='Chưa khám'");
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-3 col-sm-3 col-lg-3 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                ...
                                <span class="widget-title1">Lịch hẹn <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3 col-sm-3 col-lg-3 col-xl-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <img src="./assets/img/nv.jpg" width="100%" alt="">
                        </div>
                    </div>
