...
<div class="main-wrapper">
		...
		if($layid>0)
		{
			$p->myblogs('select * from tintuc where nguoidang="'.$ten.'" && tintuc.id='.$layid.' order by d asc');
		}
		else
		{
			$p->myblogs('select * from tintuc where nguoidang="'.$ten.'" && tentintuc like "%'.$timkiem.'%"  order by id asc');
		}
