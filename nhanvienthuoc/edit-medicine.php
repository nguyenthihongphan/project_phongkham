            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Cập nhật thuốc</h4>
                    </div>
                </div>
                <div class="row">
...
<div class="col-sm-6">
            ...
            <div class="col-sm-6">
             <div class="form-group">
                    ...
                    <input class="form-control" type="text" id="tenthuoc" name="tenthuoc" value="<?php  echo $q->luachon("select tenthuoc from thuoc where id='$layid' limit 1");?>" />
            ...
            <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="hoatchat" name="hoatchat" value="<?php  echo $q->luachon("select hoatchat from thuoc where id='$layid' limit 1");?>" />
             ...
             <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="congdung" name="congdung" value="<?php  echo $q->luachon("select congdung from thuoc where id='$layid' limit 1");?>" />
             ...
             <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="date" id="ngaysx" name="ngaysx" value="<?php  echo $q->luachon("select ngaysx from thuoc where id='$layid' limit 1");?>" />
             ...
             <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="handung" name="handung" value="<?php  echo $q->luachon("select handung from thuoc where id='$layid' limit 1");?>" />
             ...
             <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="thuonghieu" name="thuonghieu" value="<?php  echo $q->luachon("select thuonghieu from thuoc where id='$layid' limit 1");?>" />
             ...
             <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="nhasx" name="nhasx" value="<?php  echo $q->luachon("select nhasx from thuoc where id='$layid' limit 1");?>" />
             ...
             <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="noisx" name="noisx" value="<?php  echo $q->luachon("select noisx from thuoc where id='$layid' limit 1");?>" />
             ...
             <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="doituongsd" name="doituongsd" value="<?php  echo $q->luachon("select doituongsd from thuoc where id='$layid' limit 1");?>" />
            ...
            <div class="col-sm-6">
                <div class="form-group">
                        <label>Giá</label>
                        <input class="form-control" type="text" id="gia" name="gia" value="<?php  echo $q->luachon("select gia from thuoc where id='$layid' limit 1");?>" />
            ...
            <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="donvitinh" name="donvitinh" value="<?php  echo $q->luachon("select donvitinh from thuoc where id='$layid' limit 1");?>" />
            ...
            <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="sl" name="sl" value="<?php  echo $q->luachon("select sl from thuoc where id='$layid' limit 1");?>" />
             ...
             <div class="col-sm-6">
                <div class="form-group">
                        ...
                        <input class="form-control" type="text" id="sodangky" name="sodangky" value="<?php  echo $q->luachon("select sodangky from thuoc where id='$layid' limit 1");?>" />
   ...
   <?php
	...
	{	$idsua= $_REQUEST['id'];
		...
		$sl =$_REQUEST['sl'];
		if($donvitinh!='' && $tenthuoc!='')
		{			
			if($idsua>0)		  
		  			{
				 if($p->themxoasua("update thuoc set idloai='$loai', tenthuoc='$tenthuoc', hoatchat='$hoatchat', congdung='$congdung', ngaysx='$ngaysx', handung='$handung', thuonghieu='$thuonghieu',nhasx='$nhasx', noisx='$noisx', doituongsd='$doituongsd', gia='$gia', donvitinh='$donvitinh', sodangky='$sodangky',sl='$sl' where id='$idsua' limit 1 ")==1)
