...
$idnv=$q->luachon("select id from nhanvien where id='$iduser' limit 1");
...
if(isset($_GET['vnp_Amount'])){
    ...
    // $vnp_Bill_Fullname =$_GET['vnp_Bill_Fullname'];
    $vnp_Bill_LastName=$_GET['vnp_Bill_LastName'];
    // $vnp_Bill_ma=$_GET['vnp_Bill_ma'];
    ...
    //update
    if($_GET['vnp_ResponseCode']=='00'){
            $update ="UPDATE hoadonthuoc set trangthaithanhtoan='Đã thanh toán', idnv = '9' where id='$vnp_TxnRef' limit 1";
            ...
            if($mysqli->query($update)== TRUE){
                ...
                echo "<span style='color:red'>Giao dịch không thành công</span>";
                    ...
                    <h3> Hoàn thành thanh toán hóa đơn của bệnh nhân</h3>
                </div> 
            </div>
            <p>
                &nbsp;
            ...
            <a href="../lichsuthanhtoan.php"><button class="btn btn-success" type="submit">Quay lại</button></a>
            <footer class="footer">
