...
<div class="main-wrapper">
		...
		if($layid>0)
		{
                 $sqlmain =" select hoadonthuoc.iddt,hoadonthuoc.trangthaithanhtoan, hoadonthuoc.id, hoadonthuoc.idbn, hoadonthuoc.ngaylap, benhnhan.tenbn from hoadonthuoc inner join benhnhan on hoadonthuoc.idbn= benhnhan.id where benhnhan.tenbn like %$timkiem% AND hoadonthuoc.trangthaithanhtoan='Đã thanh toán' order by id asc ";
        }
        else
		{
            $sqlmain =" select hoadonthuoc.iddt,hoadonthuoc.trangthaithanhtoan, hoadonthuoc.id, hoadonthuoc.idbn, hoadonthuoc.ngaylap, benhnhan.tenbn from hoadonthuoc inner join benhnhan on hoadonthuoc.idbn= benhnhan.id AND hoadonthuoc.trangthaithanhtoan='Đã thanh toán' order by id asc ";
                            ...
                            <tbody>
                                ...
                                $dem=1;
                                    ...
                                    for ( $x=0; $x<$result->num_rows;$x++){
                                        ...
                                        <button class="btn btn-danger "><a class="text-light" href="indonthuoc.php?action=indonthuoc&iddt='.$iddtt.'&idbn='.$idbn.'" >Chi tiết</a></button>
                                        &nbsp;&nbsp;&nbsp;
                                        </div>
                                            </td>
                                        </tr>';  
