        ...
        if($action=='Hủy'){
            ...
            <div id="popup1" class="overlay" style="z-index:111">
                    ...
                    <center>                      
                        ...
                        <a href="medicine.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;Đóng&nbsp;&nbsp;</font></button></a>
                        <a href="delete-medicine.php?id='.$id.'" class="non-style-link"><button  class="btn-danger btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"<font class="tn-in-text">&nbsp;Hủy&nbsp;</font></button></a>&nbsp;&nbsp;&nbsp;
