        ...
        <div class="page-wrapper">        
            <div class="content">
                <div class="row">
                    <div class="col-md-12">  
                        ...
                        <tr >
                            ...
                            <td width="10%">
                                ...
                                $sqlmain= $mysqli->query("select * from phieusieuam where idbs='$idbs' order by id asc");
                                    ?>
                                </p>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Phiếu siêu âm( <?php echo $sqlmain->num_rows; ?> )</p>
                            </td>                   
                        </tr>
                                    </table>
                                </center>
                    ...
                    $sqlmain= "select * ,phieusieuam.loaisa, phieusieuam.id from phieusieuam inner join benhnhan on phieusieuam.idbn=benhnhan.id inner join phieukhambenh on phieusieuam.idpkb=phieukhambenh.idpkb where phieusieuam.idbs='$idbs' order by phieusieuam.id asc";
                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    <td>'.                                       
                                       ...
                                       <td>'.$loaisa.'
                                        ...
                                        <a href="insieuam.php?action=insieuam&idsa='.$id.'" class="text-light"><button  class="btn btn-success">Xem</button></a>
