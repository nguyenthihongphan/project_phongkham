...
<head>
 ...
 .selectt {
    ...
    <title>Tạo phiếu khám bệnh</title>
                    ...
                    <div class="col-lg-8 offset-lg-2">                      
                        <div class="row">          
                            <div class="col-md-6">
                                ...
                                <label for="title">Tên bệnh nhân:</label>
                                <select name="idbn" class="form-control chuyenkhoa">
                                    ...
                                    <?php
                                       require("../Admin/assets/db_config.php");
                                        ...
                                        while($row = $result->fetch_assoc()){
                                            echo "<option value='".$row['id']."'>".$row['tenbn']." - 0".$row['id']."</option>";
                                        }
                                    ?>
                                </select>
                                </div>
