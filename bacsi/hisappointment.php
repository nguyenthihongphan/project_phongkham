...
<div class="header">
        ...
        <div class="page-wrapper">
         ...
         <div class="row">
                ...
                <tr>
                    ...
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">Lịch sử khám</p>
                    </td>                   
                </tr>
                <tr>
    ...
    <?php
            $sqlmain= "select lichkham.phidichvu,lichkham.trangthai, lichkham.id,bacsi.tenbs,benhnhan.tenbn,lichkham.idbn, lichtrinh.ngaykham,lichkham.giokham,lichkham.lichngaykham from lichkham inner join lichtrinh on lichtrinh.id=lichkham.idlt inner join benhnhan on benhnhan.id=lichkham.idbn inner join bacsi on lichtrinh.idbs=bacsi.id  where lichkham.trangthai='Đã khám' order by lichtrinh.ngaykham asc ";
               ?> 
    ...
    if($_GET){
        ...
        $action=$_GET["action"];
            ...
            <div class="popup">
                        ...
                        <a class="close" href="hisappointment.php">&times;</a>
                        <div class="content">
