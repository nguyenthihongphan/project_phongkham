...
<?php
  ...
  // $pdf->SetFont(($lang == 'zh' ? 'cid0cs' : 'Helvetica'), 'I', 8);
            ...
            $sqlmain= "select * , phieusieuam.id,phieukhambenh.ketluandieutri, phieusieuam.idpkb from phieusieuam inner join benhnhan on phieusieuam.idbn=benhnhan.id inner join phieukhambenh on phieusieuam.idpkb=phieukhambenh.idpkb  where phieusieuam.idbs='$idbs' AND phieusieuam.id=$id AND phieusieuam.idbn=benhnhan.id  ";
            ...
            button:hover {
              ...
              opacity: 0.9;
                  ...
                  <table class="tablee">
                      ...
                      <span style="display:inline-block;margin-right:60px;"><strong>Mã phiếu siêu âm: '.$id.' </strong></span><br>
                  ...
                  <span id="watermark" style="font: size 13px;"><b>PHÒNG KHÁM ĐA KHOA ĐP</b></span>
                    ...
                    <div class="row" style="margin:20px;font-size:15px; text-align:center">
                     ...
                     <span  id="ProductName">Họ và tên bệnh nhân : '.$tenbn.'</span><br>
                            ...
                            <span id="CustomerCountry">Ngày siêu âm: '.$ngaysa.'</span><br>
                      ...
                      <div class="row" style="font-size:12px;" >
                        <span id="CustomerName">Chẩn đoán: '.$chandoan.'</span><br>
                        <span id="AccountProject">Kết quả khám bệnh: '.$ketluandieutri.'</span><br>
                        <span id="CustomerPostalCode">Loại siêu âm: '.$loaisa.'</span><br>
                        <span id="CustomerPostalCode">Mô tả tổn thương: '.$mota.'</span><br>
                        <span id="CustomerPostalCode">Kết quả siêu âm: '.$kqsa.'</span><br>
 ...
 $file_name = "phieusieuam_".$datetime.".pdf";
 ob_end_clean();
