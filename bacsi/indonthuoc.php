            ...
            button:hover {
              ...
              opacity: 0.9;
                  ...
                  <table class="tablee">
                      ...
                      <td id="Product">MATHANHTOAN<span id="ProuductName">  <div class="  logo-block"><img style="width:100%; width:80px;" src= "'.$qrcode.'">  </div></span></td>
                  ...
                  <span id="watermark" style="font: size 13px;"><b>PHÒNG KHÁM ĐA KHOA ĐP</b></span>
                      ...
                      <span style="display:inline-block;margin-right:60px;"><strong>Mã hóa đơn:0'.$idhd.' </strong></span>
                      </div>
                    ...
                    <div class="row" style="margin:20px;font-size:15px; text-align:center">
                     ...
                     <span  id="ProductName">Họ và tên bệnh nhân : '.$tenbn.'</span><br>
                      ...
                      <div class="row" style="font-size:12px;">
                        <span id="CustomerName">Bác sĩ kê đơn : '.$ten.'</span><br>
                        <span id="AccountProject">Chuyên khoa: '.$ckbs.'</span><br>
                        <span id="CustomerPostalCode">Số điện thoại: 0'.$sdtbs.'</span><br>
                        <span id="CustomerPostalCode">Email:'.$ebs.'</span><br>
